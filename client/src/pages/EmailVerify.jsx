...
const EmailVerify = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      />
      <form className="p-8 text-sm rounded-lg shadow-lg bg-slate-900 w-96 ">
        ...
        <button className="w-full py-3 text-white rounded-full bg-gradient-to-r from-indigo-500 to-indigo-900 ">
          Verify email
        </button>
      </form>
    </div>
